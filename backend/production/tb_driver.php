            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>รายการข้อมูลผู้ให้บริการทั้งหมด</h2>
                            ...
                            <div class="x_content">
                                <table id="datatable" class="table table-striped  table-bordered">
                                    ...
                                    <tbody>
                                    <?php
                                    $sql = "SELECT * FROM driver  ORDER BY driver_id " . $full_query_sort;
                                    ...
                                    while ($rowg = mysql_fetch_array($objedit)) {
                                        ...
                                        <tr>
                                            ...
                                            <td width="21%"
                                                style="vertical-align: middle;text-align: center;"><?= $rowg['driver_email'] ?></td>
                                            <td width="22%"
                                                style="vertical-align: middle;text-align: center;"><?= $rowg['driver_first_name'] ?> <?= $rowg['driver_last_name'] ?></td>
                                            <td width="12%"
                                                style="vertical-align: middle;text-align: center;"><?= $rowg['driver_tel'] ?></td>
                                            <td width="25%" style="vertical-align: middle;text-align: center;">
                                                <a
                                                    class="btn btn-success"
                                                    href="frm_reset_password_driver.php?driver_id=<?= $rowg['driver_id'] ?>"><i
                                                        class="fa fa-edit"></i>เปลี่ยนรหัสผ่าน</a>

                                                <a class="btn btn-warning"
                                                   href="frm_driver.php?driver_id=<?= $rowg['driver_id'] ?>&module=Edit"><i
                                                        class="fa fa-edit"></i>แก้ไข</a></td>
                                        </tr>
